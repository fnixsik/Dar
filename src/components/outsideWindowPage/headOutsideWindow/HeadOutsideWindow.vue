...
<template>
  <section class="relative w-full py-24 px-6 flex justify-center items-center overflow-hidden min-h-[500px] bg-black">
...
<style scoped>
/* Добавим эффект виньетки (затемнения по краям) для сходства с первым фото */
.bg-radial-gradient {
